...
global MPM "MPM" /* Variante del índice a calcular: "MPM" (línea internacional 3.00 USD,PPA 2021), 
                 "MPM685" u "MPMplus" (línea 8.30 USD, umbrales más
                 exigentes en educación/infraestructura). Ver 01_limpieza.do
                 y 02_privaciones.do para el detalle de cómo cambia cada indicador
                 según esta variante. */
...
*---------------------------------------------------------
* Paso 1 | Limpieza y construcción de indicadores base
*---------------------------------------------------------
include "$gdDo/01_limpieza_indicadores.do"

*---------------------------------------------------------
* Paso 2 | Construcción de variables binarias de privación
*---------------------------------------------------------
include "$gdDo/02_privaciones.do"

*---------------------------------------------------------
* Paso 3 | Cálculo del IPM con el comando oficial `mpitb`
*---------------------------------------------------------
// ssc install mpitb
...
*---------------------------------------------------------
* Paso 4 | Todas las figuras y cuadros: Parte 1 (Excel) y
...
/*------------------------------------------------------------------
 6) Mensaje final con las rutas de salida (útil para ubicar productos)
------------------------------------------------------------------*/
